...
export const getConfigurationOptions = (params?: {
    ...
    return request.get<ApiResponse<ConfigurationOption[]>>('/configuration-options', { params })
}
...
export const createConfigurationOption = (data: Partial<ConfigurationOption>) => {
    return request.post<ApiResponse<ConfigurationOption>>('/configuration-options', data)
}
...
export const getConfigurationOption = (optionId: number) => {
    return request.get<ApiResponse<ConfigurationOption>>(`/configuration-options/${optionId}`)
}
...
export const updateConfigurationOption = (optionId: number, data: Partial<ConfigurationOption>) => {
    return request.put<ApiResponse<ConfigurationOption>>(`/configuration-options/${optionId}`, data)
}
...
export const deleteConfigurationOption = (optionId: number) => {
    return request.delete(`/configuration-options/${optionId}`)
}
...
export const getConfigurationHistory = (params?: {
    ...
    return request.get<ApiResponse<any[]>>('/configuration-history', { params })
}
...
export const getConfigurationHistoryDetail = (historyId: number) => {
    return request.get<ApiResponse<any>>(`/configuration-history/${historyId}`)
}
...
export const createConfigurationHistory = (data: any) => {
    return request.post<ApiResponse<any>>('/configuration-history', data)
}
